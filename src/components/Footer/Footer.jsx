    ...
    <Wrapper>
          ...
          <div className="footer-content">
            ...
            <div className="col">
              ...
              <div className="c-item">
                <FaLocationArrow />
                <div className="text">Bankura West Bengal India</div>
              </div>
              <div className="c-item">
                <FaMobileAlt />
                <div className="text">Phone: 8016059077</div>
              </div>
              <div className="c-item">
                <FaEnvelope />
                <div className="text">Email: aniketchatterjee999@gmail.com</div>
              </div>
            </div>
            <div className="col">
      ...
      <div className="bottom-bar">
        <div className="bottom-bar-content">
          <div className="text">MADE WITH ❤️ BY Aniket Chatterjee</div>
        </div>
      </div>
    </Wrapper>
  );
